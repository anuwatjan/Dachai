...
if (isset($_POST["product_id"])) {
     ...
     $query = "SELECT * FROM view_product_detail WHERE product_id = '" . $_POST["product_id"] . "'";
                    ...
                    <div class="row">
                         <div class="col-lg-6 col-xl-12">
                              <div class="form-floating mb-3">
                                   <input class="form-control" id="product_barcode" value="<?php echo $row['product_barcode'] ?>" type="text" placeholder="Enter your name..." data-sb-validations="required" required readonly />
