<div class="container pt-5">
    <h2 class="page-section-heading  text-uppercase text-secondary mb-0">ข้อมูล </h2>
    <?php include 'line.php'; ?>
    <div class="row">
        <div class="col-md-1 col-lg-2 mb-1">
            <div class="text-center mt-1">
                <a class="btn btn-xl btn-primary" href="?page=<?= $_GET['page'] ?>&function=po"><i class="fas fa-arrow-alt-circle-down"></i> ใบสั่งซื้อสินค้า</a>
            </div>
        </div>
