    ...
    <div class="col-md-12 text-end">
      ...
      <div class="col-md-1 col-lg-3 mb-5">
        <div class="text-center mt-1">
          <a class="btn btn-xl text-white"  style="background-color:#1abc9c;" href="?page=<?= $_GET['page'] ?>&function=insert" ><i class="fas fa-download me-2"></i>เพิ่มใบสั่งซื้อสินค้า</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <tbody>
        ...
        while ($rowp = mysqli_fetch_array($rp)) { ?>
          <tr>
            ...
            <td  class="col-2"><?php echo  $rowp['po_create'] ?></td>
            <td >
              ...
              <a href="?page=<?= $_GET['page'] ?>&function=delete&product_id=<?= $rowp['product_id'] ?>" onclick="return confirm('คุณต้องการลบสินค้านี้ : <?= $rowp['po_RefNo'] ?> หรือไม่ ??')" class="btn btn-xs view_data text-white" style="background-color:red;"><i class="fa-solid fa-rectangle-xmark "></i> Delete</a>
            </td>
          </tr>
        <?php } ?>
      </tbody>
